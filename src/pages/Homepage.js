    ...
    <div className="Homepage">
              ...
              <div className="mini-bio">
                <Slide>
                  <p>
                    ...
                    and delivering high-quality, immersive experiences for
                    artists and users. Strong background in AI-driven tools,
                    scripting, and interactive design.
                  </p>
                  <br></br>
                  <br></br>
                  <p>
      ...
      <div className="tech-title">
        <div className="tech-header">
          ...
          <Slide direction={"right"} duration={1500}>
            <div
              className="tech-see-more"
              onClick={(_) => navigate("/projects#tech-projects")}
            >
              SEE MORE +
            </div>
          </Slide>
      ...
      <div className="arts-title">
        <div className="arts-header">
          ...
          <Slide direction={"right"} duration={1500}>
            <div
              className="arts-see-more"
              onClick={(_) => navigate("/projects#arts-projects")}
            >
              SEE MORE +
            </div>
          </Slide>
      ...
      <div id="arts-projects">
        <ArtProjects start={0} end={2} />
      </div>
      <div id="about">
        <About />
      </div>
